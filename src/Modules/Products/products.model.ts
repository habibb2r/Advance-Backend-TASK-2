...
const ProductSchema = new Schema<TProduct>({
  ...
  brand: { type: String, trim: true, maxlength: [30, 'Product brand must be at most 30 characters'], required: [true, 'Product brand is required'] },
  price: { type: Number, minlength: [1, 'Product price must be at least 1'], required: [true, 'Product price is required'] },
  category: {
    type: String,
    enum: {
